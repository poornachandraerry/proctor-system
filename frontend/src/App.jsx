  ...
  return (
    <>
      ...
      <Routes>
        ...
        {/* Practice test (full-screen, no sidebar) */}
        <Route path="/practice-test" element={<PrivateRoute><PracticeTestPage/></PrivateRoute>}/>
        ...
        <Route path="/" element={<PrivateRoute><Layout/></PrivateRoute>}>
          ...
          <Route path="exams/create"
            element={<PrivateRoute roles={['admin','org_admin','examiner']}><ExamCreatePage/></PrivateRoute>}/>
          <Route path="exams/:id"  element={<ExamDetailPage/>}/>
          <Route path="proctor/:examId"
            element={<PrivateRoute roles={['admin','org_admin','examiner']}><ProctorPage/></PrivateRoute>}/>
          <Route path="reports/:sessionId"
            element={<PrivateRoute roles={['admin','org_admin','examiner']}><ReportPage/></PrivateRoute>}/>
          <Route path="results/:sessionId"
            element={<PrivateRoute roles={['student']}><StudentResultPage/></PrivateRoute>}/>
          <Route path="users"
